    ...
    >
        ...
        >
            <div class="tip" :class="isVertical ? 'vertical' : 'horizontal'">
                ...
                <el-icon
                    :size="12"
                    :class="isVertical ? 'positive_angles' : 'angles-90'"
                >
...
export default {
    ...
    methods: {
        init() {
            const resizeLinePane = document.getElementById(
                this.resizeLinePaneId,
            );
            ...
            if (this.hasBoxShadow)
                resizeLine.style.boxShadow = '0px 0px 1px inset';
            ...
            if (this.secondMinValue > 0) {
                secondComponentMinRate =
                    this.secondMinValue / componentsSizeSum;
            }
            // ---------------------------------------------------------------------
            ...
            resizeLine.onmousedown = (e) => {
                ...
                if (this.isFirstComponentMasked) {
                    let { maskNode, originPosition } =
                        this.$_addMask(firstComponent);
                ...
                old2ndComponentSize =
                    secondComponent[
                        isVertical ? 'offsetWidth' : 'offsetHeight'
                    ];
        ...
        $_handleWindowResize() {
            ...
            let originalRlPercent =
                100 - firstComponentSize - secondComponentSize;
            // 缩放后 resize line 的占比(百分比)
            let recentRlPercent =
                (this.lineThickness / componentsSizeSum) * 100;
